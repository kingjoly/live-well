...
<div class="container main-container">
    ...
    <div class="row" my-4>
        <div class="col-lg-8">
            <h3 class="mt-2 text-danger">Login and Registration</h3>
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="joly">
                            
                        </div>
                        <div class="form-group">
                            <label for="surname">Surname</label>
                            <input type="password" class="form-control" id="exampleInputPassword1" placeholder="king">
                        </div>
